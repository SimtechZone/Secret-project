...
mongoose.connect("mongodb+srv://admin-deadman:Admin@deadman@cluster0.edw0m.mongodb.net/userDB",{
...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "https://morning-inlet-01901.herokuapp.com/auth/google/secrets"
  },
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: "https://morning-inlet-01901.herokuapp.com/auth/facebook/secrets",
...
app.get("/auth/facebook",
  passport.authenticate('facebook', {authType: 'reauthenticate', auth_nonce: '{random-nonce}'})
);
